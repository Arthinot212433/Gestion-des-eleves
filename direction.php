 ...
 <div class="wrapper">
  <div class="left-side">
   ...
   <br><br>
     <form method="get" action="direction.php">
        <button class="btnPe active" type="submit">Direction</button>
    </form>
    <br><br>
     <form method="get" action="pedagogie.php">
          <button class="btnPe" type="submit">Pédagogie</button>
      </form>
      <br><br>
  ...
  <div class="main-container">
   <div class="main-header">
    ...
    <div class="header-menu">
     <a class="main-header-link is-active" href="#">Pointage</a>
     ...
     <a class="main-header-link" href="/Gestion_des_eleves/Demandes/admin/M_demander.php">Materiel demandé</a>
     <a class="main-header-link" href="/Gestion_des_eleves/pointage/Presence_prof.php">Pointage des prof</a>
