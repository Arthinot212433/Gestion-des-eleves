 ...
 <div class="wrapper">
  ...
  <div class="main-container">
    <div class="main-header">
       ...
       <div class="container-items-presence">  
          
                <button class="btnPr" onclick="window.location.href='a1.php'">
                    <span>Niveau A1</span>
                    <p>Description du niveau A1</p>
                </button>
                <button class="btnPr" onclick="window.location.href='a2.php'">
                    <span>Niveau A2</span>
                    <p>Description du niveau A2</p>
                </button>
                <button class="btnPr" onclick="window.location.href='b1.php'">
                    <span>Niveau B1</span>
                    <p>Description du niveau B1</p>
                </button>
                <button class="btnPr" onclick="window.location.href='b2.php'">
                    <span>Niveau B2</span>
                    <p>Description du niveau B2</p>
                </button>
                <button class="btnPr" onclick="window.location.href='c1.php'" style="margin-left: 23.8%;">
                    <span>Niveau C1</span>
                    <p>Description du niveau C1</p>
                </button>
                <button class="btnPr" onclick="window.location.href='c2.php'">
                    <span>Niveau C2</span>
                    <p>Description du niveau C2</p>
                </button>
