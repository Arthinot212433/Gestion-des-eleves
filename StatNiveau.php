			...
			<script type="text/javascript">
				...
				function drawChart() {
					var data = google.visualization.arrayToDataTable([
						...
						$sql = "SELECT lib_Niveau, COUNT(*) as Nombre_Eleve
								FROM inscrieleve AS sous_requete
								GROUP BY lib_Niveau";
						...
						foreach ($result as $val) { ?>
							['<?php echo $val['lib_Niveau'] ?>', <?php echo $val['Nombre_Eleve'] ?>],
						<?php } ?>
					]);

          var options = {
              title: 'Statistiques des élèves par Niveau',
  ...
  <div class="main-container">
   <div class="main-header">
    ...
    <div class="header-menu">
     ...
     <a class="main-header-link is-active" href="StatNiveau.php">Statistique par Niveau</a>
  </div>
    </div>
