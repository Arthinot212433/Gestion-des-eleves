 ...
 <div class="header">
  ...
  <div class="header-menu">
      ...
      <div class="search-bar">
          <form class="search-bar" action=".php" method="POST">
 ...
 <div class="wrapper">
  ...
  <div class="main-container">
   <div class="main-header">
    ...
    <div class="header-menu">
     <a class="main-header-link is-active" href="">teste</a>
     <a class="main-header-link" href="/Gestion_des_eleves/Demandes/dashboard.php">Demande materiel</a>
