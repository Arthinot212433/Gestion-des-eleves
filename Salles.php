 ...
 <div class="wrapper">
  ...
  <div class="main-container">
   ...
   <div class="content-wrapper">
        <form method="get" action="ajouter_salle.php">
            <button class="image-button-plus" type="submit"></button>                            
        </form>
     <div>
      <br>
       <div class="container-items-salles">
        <!-- connexion DB_tab-->
            <?php
            ...
            <div class="container">
            <img class="imgSalle" src="salle.png" alt="Avatar">
            <h1 class="codeSalle"><?php echo $row['code'] ?></h1>
              <h3><b><?php echo $row['nom_salles'] ?></b></h3>
              <p><?php echo $row['centre'] ?></p>
              <h3 style="color: #40E0D0;">Capacite: </h3>
