...
if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT * FROM adherent WHERE id_Adh LIKE '$search' OR nom_Adh LIKE  '%" .$search. "%' OR prenom_Adh LIKE  '%" .$search. "%'";
...
<head>
    ...
    <link rel="stylesheet" href="./boutton.scss">
...
<body>
    ...
    <div class="app">
        <div class="header">
            <div class="menu-circle"><img class="image" src="./aff.jpg">
            </div>
            <div class="">
        ...
        <div class="wrapper">
            ...
            <div class="main-container">
                ...
                <div class="content-wrapper">
                        <form method="get" action="ajouter_adherent.php">
                    ...
                    <div class="container-items">  
                        ...
                        <table class="table table-hover table-striped">            
                                <thead>
                                    <tr>
                                        <th scope="col" class="resizeable-th">N°</th>
                                        ...
                                        <th scope="col" class="resizeable-th">Genre</th>
                                        <th scope="col" class="resizeable-th">Tel</th>
                                        <th scope="col" class="resizeable-th">Nationalite</th>
                                        <th scope="col" class="resizeable-th">Naissance</th>
                                        <th scope="col" class="resizeable-th">Lieu</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="resizeable-td"><?php echo $row['genre_Adh'] ?></td>
                                        <td class="resizeable-td"><?php echo $row['tel_Adh'] ?></td>
                                        <td class="resizeable-td"><?php echo $row['nationalite_Adh'] ?></td>
                                        <td class="resizeable-td"><?php echo $row['naissance_Adh'] ?></td>
                                        <td class="resizeable-td"><?php echo $row['lieuNaiss_Adh'] ?></td>
                                        <td class="resizeable-td">
                                        <a href="modifier_adherent.php?id_Adh=<?php echo $row['id_Adh'] ?>" class="link-dark" style="color: #0399f6; font-size: 1.4em;"><i class="fas fa-edit"></i></a>
                                            <a href="suprimer_adherent.php?id_Adh=<?php echo $row['id_Adh'] ?>" class="link-dark" style="color: hsl(0, 91%, 53%); font-size: 1.4em;"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php
                                    }
